...
**狀態:Phase 1 核心可端對端運作,持續 UI/UX 與資料層演進。** 逐項現況、啟動方式、功能狀態見根目錄 [`README.md`](README.md);當前 backlog 與接手順序見 `docs/superpowers/specs/2026-06-22-remaining-work-handoff.md`、設計索引見 `docs/superpowers/specs/README.md`(避免與 README 重複,本檔不再列舉已完成項目)。
